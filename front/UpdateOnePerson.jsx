  ...
  render() {
    ...
    return (
      <div className="container">
	      ...
	      <form>
         Edit Name:         <br/>
          <textarea onChange={this.handleChange.bind(this, 'name')} value={this.state.person1 ?  this.state.person1.name: 'NO NAME'}>
              {this.state.person1 ?  this.state.person1.name: 'NO NAME'}
          </textarea><br/><br/>
